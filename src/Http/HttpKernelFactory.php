...
use Harbor\DigitalBankingLab\Api\{MemberActivityProfilePresenter, MemberFinancialOverviewPresenter, MemberSummaryPresenter,MemberVerificationPresenter, TransferPreviewPresenter};
...
{
    public static function create(string $northstarScenario = 'normal', string $heritageScenario = 'normal',string $verificationScenario='verification-pass'): Router
    {
        ...
        return new Router(
            ...
            new TransferPreviewController($applications->previewTransfer($northstarScenario, $heritageScenario,$verificationScenario), new TransferPreviewPresenter()),
            new MemberVerificationController($applications->getMemberVerification($verificationScenario),new MemberVerificationPresenter()),
        );
    }
}
