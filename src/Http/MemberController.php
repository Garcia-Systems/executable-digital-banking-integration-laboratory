...
use Harbor\DigitalBankingLab\Api\{ApiError, MemberSummaryPresenter};
...
{
    public function __construct(private GetMemberSummary $getMemberSummary, private MemberSummaryPresenter $presenter)
    {
    }
